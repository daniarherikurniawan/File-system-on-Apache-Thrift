...
;
% testBool(This, Thing)
function_info('testBool', params_type) ->
  {struct, [{1, bool}]}
;
function_info('testBool', reply_type) ->
  bool;
function_info('testBool', exceptions) ->
  {struct, []}
;
% testByte(This, Thing)
...
function_info('testDouble', exceptions) ->
  {struct, []}
;
% testBinary(This, Thing)
function_info('testBinary', params_type) ->
  {struct, [{1, string}]}
;
function_info('testBinary', reply_type) ->
  string;
function_info('testBinary', exceptions) ->
  {struct, []}
;
