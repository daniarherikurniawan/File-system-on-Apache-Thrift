...
// Parameters:
//  - Thing
func (p *ThriftTestClient) TestBool(thing bool) (r bool, err error) {
...
func (p *ThriftTestClient) sendTestBool(thing bool) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
func (p *ThriftTestClient) recvTestBool() (value bool, err error) {
	iprot := p.InputProtocol
	if iprot == nil {
		iprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.InputProtocol = iprot
...
func NewThriftTestProcessor(handler ThriftTest) *ThriftTestProcessor {
	...
	self74 := &ThriftTestProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self74.processorMap["testVoid"] = &thriftTestProcessorTestVoid{handler: handler}
	self74.processorMap["testString"] = &thriftTestProcessorTestString{handler: handler}
	self74.processorMap["testBool"] = &thriftTestProcessorTestBool{handler: handler}
	self74.processorMap["testByte"] = &thriftTestProcessorTestByte{handler: handler}
	self74.processorMap["testI32"] = &thriftTestProcessorTestI32{handler: handler}
	self74.processorMap["testI64"] = &thriftTestProcessorTestI64{handler: handler}
	self74.processorMap["testDouble"] = &thriftTestProcessorTestDouble{handler: handler}
	self74.processorMap["testBinary"] = &thriftTestProcessorTestBinary{handler: handler}
	self74.processorMap["testStruct"] = &thriftTestProcessorTestStruct{handler: handler}
	self74.processorMap["testNest"] = &thriftTestProcessorTestNest{handler: handler}
	self74.processorMap["testMap"] = &thriftTestProcessorTestMap{handler: handler}
	self74.processorMap["testStringMap"] = &thriftTestProcessorTestStringMap{handler: handler}
	self74.processorMap["testSet"] = &thriftTestProcessorTestSet{handler: handler}
	self74.processorMap["testList"] = &thriftTestProcessorTestList{handler: handler}
	self74.processorMap["testEnum"] = &thriftTestProcessorTestEnum{handler: handler}
	self74.processorMap["testTypedef"] = &thriftTestProcessorTestTypedef{handler: handler}
	self74.processorMap["testMapMap"] = &thriftTestProcessorTestMapMap{handler: handler}
	self74.processorMap["testInsanity"] = &thriftTestProcessorTestInsanity{handler: handler}
	self74.processorMap["testMulti"] = &thriftTestProcessorTestMulti{handler: handler}
	self74.processorMap["testException"] = &thriftTestProcessorTestException{handler: handler}
	self74.processorMap["testMultiException"] = &thriftTestProcessorTestMultiException{handler: handler}
	self74.processorMap["testOneway"] = &thriftTestProcessorTestOneway{handler: handler}
	return self74
}
...
func (p *thriftTestProcessorTestBool) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ThriftTestTestBoolArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *ThriftTestTestBoolArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ThriftTestTestBoolArgs) Write(oprot thrift.TProtocol) error {
...
func (p *ThriftTestTestBoolResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ThriftTestTestBoolResult) Write(oprot thrift.TProtocol) error {
...
func (p *ThriftTestTestListArgs) readField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Thing = append(p.Thing, _elem86)
	}
